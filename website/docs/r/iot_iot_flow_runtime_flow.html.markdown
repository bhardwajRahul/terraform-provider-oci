...
sidebar_current: "docs-oci-resource-iot-iot_flow_runtime_flow"
description: |-
  Provides the Iot Flow Runtime Flow resource in Oracle Cloud Infrastructure Iot service
---
...
* `flows_document` - (Required) (Updatable) The opaque flows document for the IoT flow runtime.
