...
data "oci_database_autonomous_databases" "test_autonomous_databases" {
	...
	lifecycle_state_not_equal_to = var.autonomous_database_lifecycle_state_not_equal_to
...
* `db_version` - (Optional) A filter to return only Autonomous AI Database resources that match the specified dbVersion.
...
* `resource_pool_leader_id` - (Optional) The database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the resourcepool Leader Autonomous AI Database.
...
* `ocpu_count` - The number of OCPU cores to be made available to the database.
  ...
  For Autonomous AI Databases on dedicated Exadata infrastructure, the maximum number of cores is determined by the infrastructure shape. See [Characteristics of Infrastructure Shapes](https://www.oracle.com/pls/topic/lookup?ctx=en/cloud/paas/autonomous-database&id=ATPFG-GUID-B0F033C1-CC5A-42F0-B2E7-3CECFEDA1FD1) for shape details.
